...
![Sumber: https://en.wikipedia.org/wiki/Active_contour_model](media/Snake-contour-example.jpg)
...
![Algoritma Snakes](media/snakes_alg.png)
...
|<img src="media/lip.jpg" width="300"/> <br/>(a) Original |  <img src="media/gim.jpg" width="300"/> <br/>(b) Gaussian smoothed |
|<img src="media/map.jpg" width="300"/> <br/>(c) External energy (edge) | <img src="media/snake.jpg" width="300"/> <br/>(d) Snakes |
